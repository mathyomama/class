...
class BST {
	...
	public:
		// constructors
		explicit BST(unsigned int th=DEFAULT_THRESHOLD_VALUE); // default constructor
		BST(const std::string input, unsigned int th=DEFAULT_THRESHOLD_VALUE); // constructor from input string
